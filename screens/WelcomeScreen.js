  ...
  return (
    <View className="bg-[#002B5B] flex-1 pt-10">
      ...
      <View className="flex-1">
        <TouchableOpacity className="bg-[#8FE3CF] justify-center mx-10 p-4 rounded-lg items-center flex-row" onPress={() => navigation.navigate("Login")}>
          <Text className="text-[#002B5B] text-lg">Get Started 
            </Text>
